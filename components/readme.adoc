...
| link:camel-jms2/src/main/docs/jms2-component.adoc[JMS2] (camel-jms2) +
`jms2:destinationType:destinationName` | 2.20 | The jms2 component allows messages to be sent to (or consumed from) a JMS Queue or Topic (uses JMS 2.x API).
