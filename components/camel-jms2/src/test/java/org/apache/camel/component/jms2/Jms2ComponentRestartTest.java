...
public class Jms2ComponentRestartTest extends CamelTestSupport {
    ...
    public void testRestartWithStopStart() throws Exception {
        Jms2Component jms2 = new Jms2Component();
        jms2.setConnectionFactory((ConnectionFactory) context.getRegistry().lookupByName("activemqCF"));
        context.addComponent("jms2", jms2);

        RouteBuilder routeBuilder = new RouteBuilder(context) {
            @Override
            public void configure() throws Exception {
                from("jms2:queue:test").to("mock:test");
            }
        };
        ...
        template.sendBody("jms2:queue:test", "Hello World");
