...
public class Jms2EndpointNameOverrideTest extends CamelTestSupport {
    ...
    public void testDefaults() throws Exception {
        ...
        assertTrue(endpoint instanceof Jms2Endpoint);
        Jms2Endpoint sjms = (Jms2Endpoint)endpoint;
    ...
    public void testQueueEndpoint() throws Exception {
        ...
        assertNotNull(sjms);
        assertTrue(sjms instanceof Jms2Endpoint);
