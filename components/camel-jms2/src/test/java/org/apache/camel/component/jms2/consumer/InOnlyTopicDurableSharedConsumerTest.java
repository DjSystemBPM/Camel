...
public class InOnlyTopicDurableSharedConsumerTest extends Jms2TestSupport {

    private static final String TEST_DESTINATION_NAME = "jms2:topic:in.only.topic.consumer.test";
