 ...
 */
@ManagedResource(description = "Managed JMS2 Queue Endpoint")
public class Jms2QueueEndpoint extends Jms2Endpoint implements BrowsableEndpoint {
    private int maximumBrowseSize = -1;
    private final QueueBrowseStrategy queueBrowseStrategy;

    public Jms2QueueEndpoint(Queue destination) throws JMSException {
        this("jms2:queue:" + destination.getQueueName(), null);
        setDestinationType("queue");
        setDestination(destination);
    }

    public Jms2QueueEndpoint(String uri, JmsComponent component, String destination,
    ...
    public Jms2QueueEndpoint(String endpointUri, String destination, QueueBrowseStrategy queueBrowseStrategy) {
    ...
    public Jms2QueueEndpoint(String endpointUri, String destination) {
        super(endpointUri, destination, false);
        setDestinationType("queue");
